    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <div class="max-w-xl">
                <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">{{ __('Adicionar novo Equino') }}</h2>
                <form method="post" action="{{route('dashboard.equines.store')}}" class="mt-6 space-y-6">
                    @csrf
